...
TL_DEVICE uint32_t ptx_atom_add_relaxed_gpu(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_acquire_gpu(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_release_gpu(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_acq_rel_gpu(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_relaxed_sys(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_acquire_sys(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_release_sys(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
...
TL_DEVICE uint32_t ptx_atom_add_acq_rel_sys(const uint32_t *ptr, uint32_t value) {
  uint32_t ret;
